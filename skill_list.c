...
void		init_sklist(t_sklist *sklist)
{
	...
	sklist->sk08->dmg = 175;
	sklist->sk08->mdmg = 150;
	sklist->sk08->cost = 260;
	/* Kwame */
	...
	sklist->sk17->dmg = 350;
	sklist->sk17->mdmg = 50;
	sklist->sk17->cost = 320;
		sklist->sk18->name = ft_strdup("First aid (Heal 75hp)");
	sklist->sk18->desc = ft_strdup("A mars and it starts again");
	sklist->sk18->dmg = 0;
	sklist->sk18->mdmg = 0;
	sklist->sk18->cost = 0;
		sklist->sk19->name = ft_strdup("CHMOD");
	sklist->sk19->desc = ft_strdup("Wait, i'm getting some authorizations");
	sklist->sk19->dmg = 50;
	sklist->sk19->mdmg = 0;
	sklist->sk19->cost = -30;
	...
	sklist->sk25->mdmg = 50;
	sklist->sk25->cost = 0;
		sklist->sk26->name = ft_strdup("Magic shield (Heal 75hp)");
	...
	sklist->sk29->dmg = 0;
	sklist->sk29->mdmg = 400;
	sklist->sk29->cost = 400;
	...
	sklist->sk33->mdmg = 30;
	sklist->sk33->cost = 0;
		sklist->sk34->name = ft_strdup("Shield block (Heal 50hp)");
